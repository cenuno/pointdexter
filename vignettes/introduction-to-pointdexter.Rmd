...
`pointdexter` is compatible with the two packages most useful for working with spatial data: [`sf`](https://cran.r-project.org/web/packages/sf/index.html) and [`sp`](https://cran.r-project.org/web/packages/sp/index.html).
