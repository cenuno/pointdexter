...
*See [here](https://cran.r-project.org/doc/contrib/intro-spatial-rl.pdf) an introduction into visualizing spatial data in R using the `rgdal` package. Otherwise, see [this tutorial](https://r-spatial.github.io/sf/articles/sf5.html) for the `sf` package*
